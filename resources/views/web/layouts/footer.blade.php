<div id="kh-base-footer">
    <footer id="kh-footer">
        <div id="kh-footer-content">
            <div class="kh-footer-content-item">
                <h4>
                    Contactez-nous
                </h4>
                <ul>
                    <li>
                        <a href="tel:+2250779616033">
                    ...
                    <li>
                        <a href="mailto:klaconstructionyakro1@gmail.com">
                    ...
                    <li>
                        <a href="mailto:klaconstruction.ci@gmail.com">
                            <span class="icon-envelop icon"></span>
                            <span class="text">
                            pefaci@gmail.com
                        </span>
            ...
            <div class="kh-footer-content-item">
                ...
                <ul>
                    <li>
                        <a target="_blank" href="https://www.facebook.com/inphb.polytech">
                    ...
                    <li>
                        <a target="_blank" href="https://twitter.com/inphbpolytech">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32">
                                <title>Twitter</title>
                                <path
                    ...
                    <li>
                        <a target="_blank" href="https://www.linkedin.com/company/institut-national-polytechnique-f%C3%A9lix-houphou%C3%ABt-boigny">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32">
                    ...
                    <li>
                        <a target="_blank" href="https://www.youtube.com/channel/UCVDiYsYzaLxTgn8JZQ7vkyg">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 80 32">
                            ...
                            <span class="text">Chaine youtube</span>
                        </a>
                    </li>
                </ul>
            </div>
        </div>
        <div id="kh-footer-copy">
            © 2022 {{ config("app.name") }}, Tous droits réservé
        </div>
    </footer>
</div>
